...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=PT+Serif:400,700,400italic,700italic|Ubuntu:400,700,400italic,700italic"
    ...
    <style type="text/css">
        ...
        .layout--no-gutter.layout--has-border:not(.layout--full-width), .layout--has-gutter.layout--has-border .column__background, .layout--full-width.layout--has-border {
            border-top: 1px solid #b4b4c4;
            border-bottom: 1px solid #b4b4c4
        }

        .wrapper blockquote {
            border-left: 4px solid #b4b4c4
        }
...
<![endif]-->
<!--[if !mso]><!-->
<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ededf1;">
<!--<![endif]-->
<div class="wrapper" style="background-color: #ededf1;">
    <table style="border-collapse: collapse;table-layout: fixed;color: #7c7e7f;font-family: Ubuntu,sans-serif;"
           align="center">
        <tbody>
        <tr>
        ...
        <tr>
            <td style="padding: 0;" width="600">
                <div class="header__logo emb-logo-margin-box"
                     style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 30px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;">
    ...
    <table class="layout layout--no-gutter"
        ...
        <tbody>
            ...
            <tr>
                <td class="column"
                    style='font-size: 14px;line-height: 21px;padding: 0;text-align: left;vertical-align: top;color: #7c7e7f;font-family: "PT Serif",Georgia,serif;'
                    width="600">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                        ...
                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;font-size: 16px;line-height: 24px;color: #788991;text-align: center;">@yield('title')</h3>

                        <h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;font-size: 26px;line-height: 34px;color: #3e4751;font-family: Ubuntu,sans-serif;text-align: center;">
                            @yield('sub_title')
                        </h1>
        ...
        <tr>
            <td style="padding: 0 0 40px 0;">
                ...
                <table class="footer__left"
                       style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;color: #7c7e7f;font-family: Ubuntu,sans-serif;"
                       width="400">
                    <tbody>
                    <tr>
