...
class ComputerPatchProcessor extends Processor
{
    ...
    public function index($computerId)
    {
        ...
        return view('pages.computers.patches.index', compact('computer', 'patches', 'navbar'));
    }
    ...
    public function create($computerId)
    {
        ...
        return view('pages.computers.patches.create', compact('computer', 'form'));
    }
    ...
    public function show($computerId, $patchId)
    {
        ...
        return view('pages.computers.patches.show', compact('computer', 'patch', 'navbar'));
    }
    ...
    public function edit($computerId, $patchId)
    {
        ...
        return view('pages.computers.patches.edit', compact('computer', 'patch', 'form'));
    }
